...
export default function LayoutWrapper({ children }: { children: React.ReactNode }) {
  ...
  const isAdminRoute = pathname.startsWith("/superadmin") || pathname.startsWith("/admin/pengaturan");
  ...
  const showAccessDenied = isAdminRoute && status !== "loading" && !isSuperAdmin;
        ...
        <main className="p-4 md:p-6 lg:p-8">
          {showAccessDenied ? (
            <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
              ...
              <h1 className="text-2xl font-black text-gray-900 dark:text-white mb-2 tracking-tight">Akses Ditolak</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md mb-6 leading-relaxed">
                Anda tidak memiliki izin yang diperlukan untuk mengakses halaman menu administration. Halaman ini hanya dapat diakses oleh Superadmin.
              </p>
              <button
