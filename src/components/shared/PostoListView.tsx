...
interface PostoListViewProps {
  title?: string;
  description?: string;
}

export const PostoListView: React.FC<PostoListViewProps> = ({ 
  title = "POSTO Database", 
  description = "Inventory and distribution order monitoring." 
}) => {
  const postoData = [
             ...
             <table className="w-full text-left min-w-[800px]">
               <thead className="bg-gray-50 dark:bg-white/[0.02]">
                 <tr className="border-b border-gray-100 dark:border-gray-800">
                   ...
                   <th className="px-6 py-4 text-xs font-semibold uppercase text-gray-500 text-center">Status</th>
                   ...
                   <tr key={posto.id} className="hover:bg-gray-50/50 dark:hover:bg-white/[0.01] transition-colors">
                     ...
                     <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                           ...
                           <span className="text-sm font-medium">{posto.transportir}</span>
                        </div>
                     </td>
                     <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                     ...
                     <td className="px-6 py-4 text-center">
                        <Badge 
                           color={
                               ...
                               posto.status === "In Progress" ? "warning" : "success"
                           } 
                           size="sm"
                        >
                           {posto.status}
